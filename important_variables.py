...
LANGUAGES_DIALOGS_PER = {
    ...
    "error": "خطا",
    "password_match_error": "رمزها با یکدیگر همخوانی ندارند. دوباره امتحان کنید.",
    "network_or_email_error": "این موارد را بررسی کنید: اتصال اینترنت. موجود بودن ایمیل.",
    "email_duplicated_error": "ایمیل تکراری می باشد.",
    "name_duplicated_error": "نام کاربری وارد شده تکراری می باشد.",
    "empty_field_error": "برخی از فیلدها خالی هستند. دوباره امتحان کنید.",
...
LANGUAGES_DIALOGS_ENG = {
    ...
    "error": "Error",
    "password_match_error": "These passwords didn’t match. please try again.",
    ...
    "empty_field_error": "Some fields are empty. please try again.",
